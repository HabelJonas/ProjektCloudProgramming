...
\author{Jonas Habel}
\date{\today}
\institute{GitHub Repo: \href{https://github.com/HabelJonas/ProjektCloudProgramming}{Hier Klicken!}}
...
\begin{itemize}
  ...
  \item Federated Credentials der registrierten App hinzufügen für OIDC Auth in der Pipeline
\end{itemize}
\end{frame}
...
\begin{frame}{Das erfolgreiche Deployment}
  Das GitHub Repo ist hier zu finden: https://github.com/HabelJonas/ProjektCloudProgramming
\begin{figure}[h]
\centering
